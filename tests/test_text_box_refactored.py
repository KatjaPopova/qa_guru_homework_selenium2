...
def fill_text_form(text_box_page, name="", email="", currentAddress="", permanentAddress=""):
    text_box_page.find_element(By.ID, "userName").clear()
    text_box_page.find_element(By.ID, "userName").send_keys(name)

    text_box_page.find_element(By.ID, "userEmail").clear()
    text_box_page.find_element(By.ID, "userEmail").send_keys(email)

    text_box_page.find_element(By.ID, "currentAddress").clear()
    text_box_page.find_element(By.ID, "currentAddress").send_keys(currentAddress)

    text_box_page.find_element(By.ID, "permanentAddress").clear()
    text_box_page.find_element(By.ID, "permanentAddress").send_keys(permanentAddress)


def submit_text_form(text_box_page):
    text_box_page.find_element(By.ID, "submit").click()
    WebDriverWait(text_box_page, 10).until(
...
def check_form(text_box_page, name="", email="", currentAddress="", permanentAddress=""):
    ...
    submit_text_form(text_box_page)
    result_box = get_result_box(text_box_page)
