...
def test_all_fields_filled_with_cyrillic_letters(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Санкт-Петербург")

    text_box_page.driver.find_element(By.ID, "submit").click()

    time.sleep(3)

    result_box = text_box_page.driver.find_element(By.ID, "output")
...
def test_all_fields_filled_with_latin_letters(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Olga Ivanova")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("olgaivanova@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Moscow")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Saint-Petersburg")
...
def test_name_surname_patronymic_in_name_field(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петров Петр Петрович")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Санкт-Петербург")
...
def test_short_name(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Ян")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("yan@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Сочи")
...
def test_long_name(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Константинопольская Апполинария Максимилиановна")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("yan@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Сочи")
...
def test_hyphen_in_name_field(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Иван Мамин-Сибиряк")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("yan@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Сочи")
...
def test_email_in_mixed_case(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("PetrovPetr@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Казань")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Москва")
...
def test_numbers_in_email(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov1985@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Тюмень")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Омск")
...
def test_current_address_equals_permanent_address(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrovpetya@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Москва")
...
def test_current_address_with_city_street_house_flat(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва, ул. Тверская, дом 5, кв. 23")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Краснодар")
...
def test_current_address_with_city_street_house_building_flat(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва, ул. Тверская, дом 5, корп. 1, кв. 23")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Краснодар")
...
def test_current_address_only_city_and_street(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва, ул. Тверская")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Краснодар")
...
def test_long_current_address(text_box_page):
    ...
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys(long_current_address)
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Краснодар")
...
def test_short_current_address(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Уфа")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Краснодар")
...
def test_current_address_contains_symbols(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys(
        "г. Санкт-Петербург, Невский пр., д. 15/2, кв. №34")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Пермь")
...
def test_permanent_address_with_city_street_house_flat(text_box_page):
    ...
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Казань")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Москва, ул. Тверская, дом 5, кв. 23")
...
def test_permanent_address_with_city_street_house_building_flat(text_box_page):
    ...
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Казань")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys(
        "Москва, ул. Тверская, дом 5, корп. 1, кв. 23")
...
def test_permanent_address_only_city_and_street(text_box_page):
    ...
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Казань")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Москва, ул. Тверская")
...
def test_long_permanent_address(text_box_page):
    ...
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys(long_permanent_address)
...
def test_short_permanent_address(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Мурманск")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Уфа")
...
def test_permanent_address_contains_symbols(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Пермь")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys(
        "г. Санкт-Петербург, Невский пр., д. 15/2, кв. №34")
...
def test_email_with_no_mail_symbol(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrovexample.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Мурманск")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Уфа")
    ...
    error_text = text_box_page.driver.find_element(By.ID, "userEmail").get_attribute("validationMessage")
...
def test_long_email(text_box_page):
    text_box_page.driver.find_element(By.ID, "userName").send_keys("Петр Петров")
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("петров@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Санкт-Петербург")
...
def test_html_injection(text_box_page):
    ...
    text_box_page.driver.find_element(By.ID, "userName").send_keys(payload)
    text_box_page.driver.find_element(By.ID, "userEmail").send_keys("petrov@example.com")
    text_box_page.driver.find_element(By.ID, "currentAddress").send_keys("Москва")
    text_box_page.driver.find_element(By.ID, "permanentAddress").send_keys("Санкт-Петербург")
