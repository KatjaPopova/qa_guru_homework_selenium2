...
def test_unsuccessful_login(login_page):
    login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='login-input']").send_keys("Ekaterina")
    login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='password-input']").send_keys("123456")
    login_page.driver.find_element(By.XPATH, "//button[text()='Login']").click()

    time.sleep(3)

    error = login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='error-message']").text
...
def test_input_fields(login_page):
    login = login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='login-input']")
    password = login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='password-input']")
...
def test_button_login_enabled(login_page):
    button = login_page.driver.find_element(By.XPATH, "//button[text()='Login']")
...
def test_invalid_password_valid_login(login_page):
    login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='login-input']").send_keys("Ekaterina")
    login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='password-input']").send_keys("invalid")
    login_page.driver.find_element(By.XPATH, "//button[text()='Login']").click()
...
def test_too_short_login(login_page):
    login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='login-input']").send_keys("Hi")
    login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='password-input']").send_keys("123456")
    login_page.driver.find_element(By.XPATH, "//button[text()='Login']").click()
...
def test_too_short_password(login_page):
    login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='login-input']").send_keys("Ekaterina")
    login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='password-input']").send_keys("123")
    login_page.driver.find_element(By.XPATH, "//button[text()='Login']").click()
...
def test_sql_injection_in_login_field(login_page):
    login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='login-input']").send_keys("' OR 1=1 --")
    login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='password-input']").send_keys("123456")
    login_page.driver.find_element(By.XPATH, "//button[text()='Login']").click()

    time.sleep(3)

    error = login_page.driver.find_element(By.CSS_SELECTOR, "[data-testid='error-message']")
